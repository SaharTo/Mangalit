...
module.exports.deleteReview = async (req, res) => {
  ...
  await Meal.findByIdAndUpdate(MealId, { $pull: { mealReviews: reviewId } });
  await Review.findByIdAndDelete(req.params.MealId);
  res.send("Review deleted successfully");
};
/*module.exports.createReview = async (req, res) => {
  console.log("Entered to create Review function");
