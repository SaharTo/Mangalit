...
export class Meal extends Component {
  ...
  getMeal = async () => {
    ...
    fetch(`https://immense-inlet-06578.herokuapp.com/meals/${id}`, { credentials: "include" })
      .then((res) => {
        if (res.ok) {
          res.json()
            .then((meal) => {
  ...
  deleteMeal = async (mealId) => {
    fetch(`https://immense-inlet-06578.herokuapp.com/meals/${mealId}`, {
      method: "DELETE",
      credentials: "include",
    })
      .then(() => this.goBack())
  ...
  like = () => {
    const id = this.props.match.params.id;
    fetch(`https://immense-inlet-06578.herokuapp.com/meals/${id}/like`, {
      method: "PUT",
      credentials: "include",
    })
      .then((res) => res.json())
